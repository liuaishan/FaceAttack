...
parser.add_argument('--load_model_path', default="params_res50IR_cos_CA.pkl", help='load model path')
parser.add_argument('--load_margin_path', default="margin_res50IR_cos_CA.pkl", help='load model path')
parser.add_argument('--save_model_path', default="params_res50IR_cos_CA.pkl", help='save model path')
parser.add_argument('--save_margin_path', default="margin_res50IR_cos_CA.pkl", help='save model path')
parser.add_argument('--train_data_root', default="CASIA_WebFace/CASIA_align/", help='training dataset root')
parser.add_argument('--train_data_list', default="CASIA_list.txt", help='training dataset file list')
parser.add_argument('--train_data_fail', default="CASIA_fail.txt", help='training dataset failed list')
parser.add_argument('--lr', type=float, default=0.0002, help='Learning Rate')
parser.add_argument('--train_dataset', default='CASIA',  help='type of train dataset')
